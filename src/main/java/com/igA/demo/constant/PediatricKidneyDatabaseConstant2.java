...
//现病史
    public final static String xianbingshi2 ="select * from dbo.mh2 where flag='2' and id='?'";
//个人史
...
public final static String jieju2 ="  select \n" +
        ...
        "\n" +
        "replace(replace(replace(replace(replace(OPERTYPE,'_',','),'腹膜透析','1'),'血液透析','2'),'肾移植','3'),'其它','4') as zhyl9200002,\n" +
        "\n" +
...
public final static String yongyao2 ="  \n" +
        ...
        "case when CMCAT='降压药' then '1' when CMCAT='利尿剂' then '2' when CMCAT='免疫抑制药物' then '3'  end as zhyl7000002,\n" +
        "b.Column3 as zhyl7000003,\n" +
        "CMTRT as zhyl7000004,\n" +
...
public final static String suifangyongyao2=" select  \n" +
        ...
        "case when CMCAT='降压药' then '1' when CMCAT='利尿剂' then '2' when CMCAT='免疫抑制药物' then '3'  end as zhyl8100038,\n" +
        "b.Column3 as zhyl8100039,\n" +
        "CMTRT as zhyl8100040,\n" +
        "case when CMDOSFRM='片剂' then '1'when CMDOSFRM='注射剂' then '2'when CMDOSFRM='胶囊剂' then '3'when CMDOSFRM='颗粒剂' then '4'when CMDOSFRM='丸剂' then '5'\n" +
        "when CMDOSFRM='栓剂' then '6'\n" +
